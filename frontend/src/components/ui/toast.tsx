...
>(({ className, variant = 'default', ...props }, ref) => (
  <ToastPrimitives.Root
    ...
    className={cn(
      ...
      'data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full sm:data-[state=open]:slide-in-from-bottom-full',
